...
//        System.out.println("Lists.ArrayList index "+idOfValueToFind+": "+lista.get(idOfValueToFind));
//        System.out.println("Lists.ArrayList size: "+lista.size());
...
//        System.out.println("Lists.LinkedList index "+idOfValueToFind+": "+lista2.get(idOfValueToFind));
////        System.out.println(lista2.toString());
//        System.out.println("Lists.LinkedList size: "+lista2.size());
//
//        startTime = System.nanoTime();
//        System.out.println("Lists.LinkedList index "+idOfValueToFind+": "+lista2.get(idOfValueToFind));
//        endTime = System.nanoTime();
...
//        }
//
//        Agorythmes.AlgorythmesAndArrays arrays = new Agorythmes.AlgorythmesAndArrays(new int[]{1, 2, 4, 5,1, 7, 9,1,1, 11, 14, 16, 24, 26, 30, 33, 34, 39,50});
...
//        int endNumber = 24;
//        try {
//            if(endNumber<2) throw new Agorythmes.Prime_Numbers_List_Exception("No numbers in the list.");
//            arrays.primaryNumbers(endNumber).stream().map(x -> x + ", ").forEach(System.out::print);
//
//        } catch (Agorythmes.Prime_Numbers_List_Exception ex){
//            System.out.println(ex);
//        }
//
//        try {
//            if(endNumber<0) throw new Agorythmes.RecurtionNumberFormatException("No numbers in the list.");
//            System.out.println("\nSum of all numbers form 0 to "+endNumber+" is: "+arrays.recurtionSum(endNumber));
//
//        } catch (Agorythmes.RecurtionNumberFormatException ex){
//            System.out.println(ex);
//        }
//
...
//        Lists.ReversedPolishNotation RPN = new Lists.ReversedPolishNotation(string);
//        System.out.println(RPN.toString());
//    }
//
//    public static void factorial(int number){
//        Agorythmes.Factorial factorial = new Agorythmes.Factorial(number);
...
////        List<Integer> listIntToSort = new Lists.LinkedList<>();
////        List<String> listStringToSort = new Lists.LinkedList<>();
////        for(int i = 0; i < listLength; i++){
////            listIntToSort.add((int) (Math.random()*listLength));
////        }
////        for(int i = 0; i< listLength; i++){
